...
namespace CircusTrein_BetterForeachNoStatic
{
    public partial class FRM_CircusTrein : Form
    {
        ...
        private void BTN_AddAnimal_Click(object sender, EventArgs e)
        {
            ...
            {
                Animal animal = new Animal(DeclareFoodType(), DeclareSize(), animalCollection);
            }
            UpdateTextboxes();
        }
        private void BTN_ClassifyAnimals_Click(object sender, EventArgs e)
        {
            ...
            train.ClassifyAllAnimals(animalCollection, train);
            DisplayEverythingInListbox();
        }
        private void BTN_AddRandomAnimals_Click(object sender, EventArgs e)
        {
            animalCollection.OnlyRandomAnimals(Convert.ToInt32(NUD_AnimalMultiplier.Value), animalCollection);
            UpdateTextboxes();
        }
    }
}
